...
app.get('/produtos', (req, res) => {
  res.json([
    ...
    },
    {
      ...
      preco: 259.9,
      categoria: 'Terror',
      imagem: 'https://editors.dexerto.com/wp-content/uploads/2022/12/26/death-stranding-epic-games-store-free-christmas-gift.jpg'
    },
    {
      id: 7,
      ...
      preco: 269.9,
      categoria: 'Terror',
      imagem: 'https://www.vavache.fr/wp-content/uploads/2019/03/vignette_Resident_Evil_2_Remake-large.png'
    },
    {
      id: 8,
